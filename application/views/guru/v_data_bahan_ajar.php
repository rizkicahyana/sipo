...
<body>
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Data Bahan Ajar</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
             <div class="row">
                <div class="col-lg-12">
                    <div>
                        <a href="<?php echo site_url('sipo/dashboard_guru/beranda');?>">Dashboard Guru</a> -> Lihat Data Akun
                    </div>
                </div>
            </div>
            <!-- /.row -->
                            	 ...
                            	 <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        ...
                                        $nomor = 1;
                                            ...
                                            echo "<td><a href='".base_url('assets/bahan_ajar/'.$data->bahan_ajar)."'>".$data->bahan_ajar."</a></td>";
                                            echo "<td><a href='".site_url('sipo/dashboard_guru/ubah_bahan_ajar/'.$data->id_bahan_ajar)."'>Ubah</a> | <a href='".site_url('sipo/dashboard_guru/hapus_bahan_ajar/'.$data->id_bahan_ajar)."'>Hapus</a></td>";
                                            echo "</tr>";
