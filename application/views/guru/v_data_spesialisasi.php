...
<head>
    <meta charset="utf-8">
    <title>Data Spesialisasi | SIPO</title>
...
<body>
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Data Spesialisasi</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
             <div class="row">
                <div class="col-lg-12">
                    <div>
                        <a href="<?php echo site_url('sipo/dashboard_guru/beranda');?>">Dashboard Guru</a> -> Data Spesialisasi
                    </div>
                </div>
            </div>
            <!-- /.row -->
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        ...
                                        $nomor = 1;
                                            ...
                                            echo "<tr>";
                                            echo "<td>".$nomor."</td>";
                                            echo "<td>".$data->nama1.", ".$data->gelar."</td>";
                                            echo "<td>".$data->nama2."</td>";
                                            echo "</tr>";
