        ...
        <div id="page-wrapper">
            <div class="row">
             ...
             <div class="row">
                <div class="col-lg-12">
                    <div>
                        <a href="<?php echo site_url('sipo/dashboard_guru/beranda');?>">Dashboard Guru</a> -> Lihat Data Bahan Ajar
                    </div>
                </div>
            </div>
            <!-- /.row -->
                            ...
                            <div class="dataTable_wrapper">
                            	<?php
									foreach($spesialisasi as $data){
										echo "<a href='".site_url('sipo/dashboard_guru/lihat_bahan_ajar/'.$data->id_spesialisasi)."'>".$data->nama_mapel."</a><br/>";
									}
								?>
                            <!-- /.table-responsive -->
                        </div>
