...
<head>
    <meta charset="utf-8">
    <title>Tambah Bahan Ajar | SIPO</title>
...
<body>
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Tambah Bahan Ajar</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
             <div class="row">
                <div class="col-lg-12">
                    <div>
                        <a href="<?php echo site_url('sipo/dashboard_guru/beranda');?>">Dashboard Guru</a> -> Tambah Bahan Ajar
                    </div>
                </div>
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
							...
							<?php
								echo $pesan."<br/><br/>";
								echo form_open_multipart('sipo/dashboard_guru/proses_tambah_bahan_ajar');
							?>
							<table>
								<tr valign="top">
									<td>Spesialisasi</td>
									<td>:</td>
									<td>
										<select name="id_spesialisasi" class="form-control" required>
											<option disabled selected>-Pilih Spesialisasi-</option>
											<?php
												foreach($spesialisasi as $data){
													echo "<option value='".$data->id_spesialisasi."'>".$data->nama_guru.", ".$data->gelar." - ".$data->nama_mapel."</option>";
												}
											?>
										</select>
										<?php
											echo form_error('id_spesialisasi', '<div style="color:red">','</div>');
										?>
									</td>
								</tr>
								<tr valign="top">
									...
									<td>
										...
										<?php
											echo form_error('kelas', '<div style="color:red">','</div>');
										?>
									</td>
								</tr>
								<tr valign="top">
										...
										<select name="id_semester" class="form-control" required>
											...
											<?php
												foreach($semester as $data){
													echo "<option value='".$data->id_semester."'>".$data->keterangan."</option>";
												}
											?>
										</select>
										<?php
											echo form_error('id_semester', '<div style="color:red">','</div>');
										?>
									</td>
								</tr>
								<tr>
