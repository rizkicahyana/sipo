        ...
        <div id="page-wrapper">
            <div class="row">
             ...
             <div class="row">
                <div class="col-lg-12">
                    <div>
                        <a href="<?php echo site_url('sipo/dashboard_admin/beranda');?>">Home</a> -> Tambah Data Siswa
                    </div>
                </div>
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
						...
						<?php
							echo $pesan."<br/><br/>";
						?>
						<?php echo form_open('sipo/dashboard_admin/proses_tambah_siswa');?>
						<table>
							<tr valign="top">
								<td>NIS</td>
								<td>:</td>
