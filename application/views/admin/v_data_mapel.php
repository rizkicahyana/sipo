...
<head>
    <meta charset="utf-8">
    <title>Data Mata Pelajaran | SIPO</title>
...
<body>
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Tabel Data Mata Pelajaran</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
             <div class="row">
                <div class="col-lg-12">
                    <div>
                        <a href="<?php echo site_url('sipo/dashboard_admin/beranda');?>">Home</a> -> Data Mata Pelajaran
                    </div>
                </div>
            </div>
            <!-- /.row -->
