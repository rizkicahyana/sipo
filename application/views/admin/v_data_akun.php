...
<body>
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Tabel Data Akun</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
             <div class="row">
                <div class="col-lg-12">
                    <div>
                        <a href="<?php echo site_url('sipo/dashboard_admin/beranda');?>">Home</a> -> Data Akun
                    </div>
                </div>
            </div>
            <!-- /.row -->
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        ...
                                        $nomor = 1;
                                            ...
                                            echo "<td><img src=".base_url('assets/foto/'.$data->foto)." height='150px' width='150px'></td>";
                                            echo "<td>".$data->nomor_level."</td>";
                                            echo "<td>".$data->status_akun."</td>";
                                            echo "<td><a href=".site_url('sipo/dashboard_admin/konfirmasi_akun/'.$data->id_akun).">Konfirmasi</a></td>";
                                            echo "</tr>";
