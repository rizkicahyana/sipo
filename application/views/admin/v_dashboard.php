...
<body>
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo site_url('sipo/dashboard_admin/beranda');?>">Dasboard Admin</a>
		...
		<div id="page-wrapper">
            <div class="row">
             ...
             <div class="row">
                <div class="col-lg-12">
                    <div>
                        <a href="<?php echo site_url('sipo/dashboard_admin/beranda');?>">Dashboard Administrator</a> -> Beranda
                    </div>
                </div>
            </div>
            <!-- /.row -->
	...
	Hai, <?php echo $this->session->userdata('username');?>! Selamat datang di Sistem Pembelajaran Online!<br/><br/>
	<?php echo "<img src=".base_url('assets/foto/'.$this->session->userdata('foto'))." height='150px' width='150px'>"; ?>
	<br/><br/>
	
	<a href="<?php echo site_url('sipo/dashboard_admin/keluar');?>">Keluar</a>
