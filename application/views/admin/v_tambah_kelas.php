...
<body>
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Tambah Data Kelas</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
             <div class="row">
                <div class="col-lg-12">
                    <div>
                        <a href="<?php echo site_url('sipo/dashboard_admin/beranda');?>">Home</a> -> Tambah Data Kelas
                    </div>
                </div>
            </div>
            <!-- /.row -->
                    ...
                    <div class="panel panel-default">
                        ...
                        <!-- /.panel-heading -->
                         ...
                         <div class="dataTable_wrapper">
							<?php
								echo $pesan."<br/><br/>";
								echo form_open('sipo/dashboard_admin/proses_tambah_kelas');
							?>
							<table>
								<tr valign="top">
									<td>Jurusan</td>
										...
										<select name="id_jurusan" required/>
											...
											<?php
												foreach($jurusan as $data){
													echo "<option value=".$data->id_jurusan.">".$data->nama."</option>";
												}
											?>
										</select>
										<?php
											echo form_error('id_jurusan', '<div style="color:red">','</div>');
										?>
									</td>
								</tr>
								<tr valign="top">
