...
<head>
    <meta charset="utf-8">
    <title>Tambah Mata Pelajaran | SIPO</title>
...
<body>
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Tambah Data Mata Pelajaran</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
             <div class="row">
                <div class="col-lg-12">
                    <div>
                        <a href="<?php echo site_url('sipo/dashboard_admin/beranda');?>">Home</a> -> Tambah Data Mata Pelajaran
                    </div>
                </div>
            </div>
            <!-- /.row -->
                    ...
                    <div class="panel panel-default">
                        ...
                        <!-- /.panel-heading -->
                         ...
                         <div class="dataTable_wrapper">
							<?php
								echo $pesan."<br/><br/>";
								echo form_open('sipo/dashboard_admin/proses_tambah_mapel');
							?>
							<table>
								<tr valign="top">
