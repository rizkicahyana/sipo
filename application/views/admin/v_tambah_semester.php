...
<head>
    <meta charset="utf-8">
    <title>Tambah Semester | SIPO</title>
        ...
        <div id="page-wrapper">
            <div class="row">
             ...
             <div class="row">
                <div class="col-lg-12">
                    <div>
                        <a href="<?php echo site_url('sipo/dashboard_admin/beranda');?>">Home</a> -> Tambah Data Semester
                    </div>
                </div>
            </div>
            <!-- /.row -->
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
						...
						<?php
							echo $pesan."<br/><br/>";
							echo form_open('sipo/dashboard_admin/proses_tambah_semester');
						?>
						<table>
							<tr valign="top">
								<td>Nama Semester</td>
							...
							<tr valign="top">
								...
								<td>
									...
									<?php
										echo form_error('keterangan', '<div style="color:red">','</div>');
									?>
								</td>
							</tr>
							<tr>
