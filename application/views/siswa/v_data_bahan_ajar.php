                            	 ...
                            	 <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        ...
                                        $nomor = 1;
                                            ...
                                            echo "<td><a href='".site_url('sipo/dashboard_siswa/ubah_bahan_ajar/'.$data->id_bahan_ajar)."'>Ubah</a> | <a href='".site_url('sipo/dashboard_siswa/hapus_bahan_ajar/'.$data->id_bahan_ajar)."'>Hapus</a></td>";
                                            echo "</tr>";
