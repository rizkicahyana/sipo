...
<html>
<head>
	<title>Dashboard Siswa | SIPO</title>
</head>
<body>
                 ...
                 <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
									<a href="<?php echo site_url('sipo/dashboard_siswa/pre_lihat_bahan_ajar/'.$nis);?>">Lihat Bahan Ajar</a><br/>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
        ...
        <div id="page-wrapper">
            <div class="row">
             ...
             <div class="row">
                <div class="col-lg-12">
                    <div>
                        <a href="<?php echo site_url('sipo/dashboard_siswa/beranda');?>">Dashboard Siswa</a> -> Beranda
                    </div>
                </div>
            </div>
            <!-- /.row -->
